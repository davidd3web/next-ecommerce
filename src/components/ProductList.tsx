            ...
            {res.items.map((product:products.Product) => (
                ...
                >
                    ...
                    <div className="flex justify-between">
                        ...
                        <span className="font-semibold">${product.priceData?.discountedPrice}</span>
                    </div>
                    {product.additionalInfoSections && <div className="text-sm text-gray-500" dangerouslySetInnerHTML={{__html:DOMPurify.sanitize( product.additionalInfoSections.find((section:any) => section.title==="shortDesc")?.description || "")}}></div>}
